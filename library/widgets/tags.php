...
class Rolo_Widget_Tags extends WP_Widget {

	function Rolo_Widget_Tags() {
		$widget_ops = array( 'classname' => 'tags', 'description' => __('An advanced widget that gives you total control over the output of your tags.','rolopress') );
		$control_ops = array( 'width' => 500, 'height' => 350, 'id_base' => 'rolopress-tags' );
		$this->WP_Widget( 'rolopress-tags', __('Tags', 'rolopress'), $widget_ops, $control_ops );
	}
	...
	function form( $instance ) {
		...
		//Defaults
		$defaults = array( 'title' => __('Tags', 'rolopress'), 'format' => 'flat', 'unit' => 'pt', 'smallest' => 8, 'largest' => 22, 'link' => 'view', 'number' => 45, 'taxonomy' => 'post_tag'  );
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'taxonomy' ); ?>"><?php _e('Taxonomy:', 'rolopress'); ?> <code>taxonomy</code></label> 
